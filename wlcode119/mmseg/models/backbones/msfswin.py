...
class ASPP(nn.Module):
    def __init__(self, in_channels, out_channels, dilations=(1, 6, 12, 18)):
        ...
        Args:
            ...
            dilations (tuple): Atrous rates for different branches.
        """
    ...
    def forward(self, x):
        ...
        aspp_features.append(global_feature)
...
class SwinTransformer(BaseModule):
    ...
    def __init__(self,
        ...
        for i in out_indices:
            ...
            # 计算 ASPP 输入通道数
        aspp_in_channels = embed_dims * (2 ** (len(depths) - 1))
    ...
    def forward(self, x):
        ...
        # 使用最后一层特征作为 ASPP 输入
        aspp_input = outs[-1]
        aspp_output = self.aspp(aspp_input)

        # return outs
        # 返回原有特征和 ASPP 特征
        return outs[:-1] + [aspp_output]
